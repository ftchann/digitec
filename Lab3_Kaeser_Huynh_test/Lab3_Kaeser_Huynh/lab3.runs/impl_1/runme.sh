...
HD_PWD='C:/Users/Yann/digitec/Lab3_Kaeser_Huynh_test/Lab3_Kaeser_Huynh/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log results.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source results.tcl -notrace
