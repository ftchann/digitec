...
HD_PWD='C:/Users/Yann/digitec/report_4/report_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm2.tcl
