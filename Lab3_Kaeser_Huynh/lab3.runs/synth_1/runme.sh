...
HD_PWD='C:/Users/Yann/digitec/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log results.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source results.tcl
